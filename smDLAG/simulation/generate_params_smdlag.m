function params = generate_params_smdlag(yDims, xDim, binWidth, ...
                                         hyperparams, snr, tau, eps, D, Z)
% params = generate_params_smdlag(...)
%
% Description: Randomly generate smDLAG model parameters, within 
%              specified constraints. The params output structure is
%              compatible with other smDLAG codepack functions.
%
% Arguments:
%
...
%     Z         -- (xDim x 1) cell array; Z{j} is a (1 x S_j) array with 
%                  S_j inducing point locations for latent j (in ms)
%
% Outputs:
%
