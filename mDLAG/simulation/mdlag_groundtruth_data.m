...
gp_params.tau = [30 80 50 120 100 40 70];   % GP timescales
gp_params.eps = 1e-3.*ones(1,xDim);         % GP noise variances
...
[seqTrue, paramsTrue] = simdata_mdlag(N, T, binWidth, yDims, xDim, ...
...
units = 'ms';
gp_params = plotGPparams_mdlag(paramsTrue, binWidth,...
                               'sigDims', sigDimsTrue, ...
                               'units', units);
...
save('demo/data/mdlag_demo_data.mat', 'seqTrue', ...
     'paramsTrue', 'binWidth', 'sigDimsTrue');