function [f,df] = grad_GPparams_exp_approx(p,precomp,const)
%
% [f, df] = grad_GPparams_exp_approx(p, precomp, const)  
%
% Description: A smooth approximation of the gradient for exponential 
%              function GP parameter optimization. This function is called
%              by minimize.m.
%
% Arguments:
%
%     p          -- variable with respect to which optimization is performed,
%                   where p = [gamma(i); D(2,i); ....; D(M,i)]'
