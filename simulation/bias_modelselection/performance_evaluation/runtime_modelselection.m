...
% Reference lines
% Linear scaling
h4 = line([40 200], 10^(-4.1).*[40 200], ...
     'color', [0.5 0.5 0.5], 'linestyle', '--', 'linewidth', 1.5);
% Cubic scaling
h5 = line([70 200], 10^(-6.5).*[70 200].^3, ...
     'color', [0.5 0.5 0.5], 'linestyle', ':', 'linewidth', 1.5);
% Time domain
...
h3 = plot(Tlist, mean_timePerIter_freq, ...
          'color', FREQCOLOR, ...
          'linestyle', '-', ...
          'linewidth', 1.5, ...
          'marker', '.', ...
...
p = fill([Tlist, fliplr(Tlist)], ...
         ...
         'facealpha', 0.2);
p.FaceColor = FREQCOLOR;
h3 = plot(Tlist, mean_numIters_freq, ...
          'color', FREQCOLOR, ...
          'linestyle', '-', ...
          'linewidth', 1.5, ...
          'marker', '.', ...
...
% Reference lines
% Linear scaling
h4 = line([50 200], 10^(0).*[50 200], ...
     'color', [0.5 0.5 0.5], 'linestyle', '--', 'linewidth', 1.5);
% Cubic scaling
h5 = line([70 200], 10^(-2.3).*[70 200].^3, ...
     'color', [0.5 0.5 0.5], 'linestyle', ':', 'linewidth', 1.5);
% Time domain
p = fill([Tlist, fliplr(Tlist)], ...
...
p = fill([Tlist, fliplr(Tlist)], ...
         ...
         'facealpha', 0.2);
p.FaceColor = FREQCOLOR;
h3 = plot(Tlist, mean_totalRuntime_freq, ...
          'color', FREQCOLOR, ...
          'linestyle', '-', ...
          'linewidth', 1.5, ...
          'marker', '.', ...
