% generate_data_modelselection.m
%
% Description: Generate synthetic datasets to characterize bias in model
%              selection as a function of sequence length. Ground truth 
%              data and parameters are saved to files. We'll also titrate
%              signal-to-noise ratios across runs.
%
% Author: 
...
for runIdx = 1:numRuns
    ...
    snr = snrRunList(runIdx).*ones(1,numGroups);
    [seqTrue, trueParams] ...
