...
learnTimescales = false;  % Fix timescale parameters
...
parfor runIdx = 1:numRuns
    ...
    for i = 1:numPartitions
        ...
        initParams = init_mdlag(seqSub, ...
                                ...
                                'saveCcov', saveCcov);
        initParams.gamma = ws.trueParams.gamma;
...
for runIdx = 1:numRuns
    ...
    for i = 1:numPartitions
        ...
        currSaveFile = sprintf('%s/T%04d_freq_fixtau.mat', currSaveDir, T);
