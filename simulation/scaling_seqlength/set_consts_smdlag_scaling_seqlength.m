% set_consts_smdlag_scaling_seqlength.m
%
...
%% For the analysis of bias as a function of number of inducing points

Tfix = Tlist(6);  % Fix the number of time points at a relatively high value
% A list of the minimum number of inducing points to get each desired
% effective sampling rate.
Slist = [ceil(Tfix * binWidth ./ linspace(nyqperiod*3, nyqperiod, 5)) Tfix];
numS = length(Slist);