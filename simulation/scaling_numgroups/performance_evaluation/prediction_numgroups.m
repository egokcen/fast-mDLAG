% prediction_numgroups.m
%
% Description: Characterize the leave-one-out predictive performance of
%              mDLAG as a function of group numer. Compare time, inducing,
...
line([numGroupsList(1) numGroupsList(end)], [nsceil nsceil], ...
     'Color', 'k', ...
     'LineStyle', '--', ...
     'LineWidth', 1.5);
% Time domain
...
h1 = plot(numGroupsList, mean_R2_time, ...
          'color', TIMECOLOR, ...
          'linestyle', '-', ...
          'linewidth', 1.5, ...
          'marker', '.', ...
...
h2 = plot(numGroupsList, mean_R2_sparse, ...
          'color', SPARSECOLOR, ...
          'linestyle', '-', ...
          'linewidth', 1.5, ...
          'marker', '.', ...
...
h3 = plot(numGroupsList, mean_R2_freq, ...
          'color', FREQCOLOR, ...
          'linestyle', '-', ...
          'linewidth', 1.5, ...
          'marker', '.', ...
...
p = fill([numGroupsList, fliplr(numGroupsList)], ...
         ...
         'facealpha', 0.2);
p.FaceColor = TIMECOLOR;
h1 = plot(numGroupsList, mean_RMSE_time, ...
          'color', TIMECOLOR, ...
          'linestyle', '-', ...
          'linewidth', 1.5, ...
          'marker', '.', ...
...
p = fill([numGroupsList, fliplr(numGroupsList)], ...
         ...
         'facealpha', 0.2);
p.FaceColor = SPARSECOLOR;
h2 = plot(numGroupsList, mean_RMSE_sparse, ...
          'color', SPARSECOLOR, ...
          'linestyle', '-', ...
          'linewidth', 1.5, ...
          'marker', '.', ...
...
p = fill([numGroupsList, fliplr(numGroupsList)], ...
         ...
         'facealpha', 0.2);
p.FaceColor = FREQCOLOR;
h3 = plot(numGroupsList, mean_RMSE_freq, ...
          'color', FREQCOLOR, ...
          'linestyle', '-', ...
          'linewidth', 1.5, ...
          'marker', '.', ...
...
line([numGroupsList(1), numGroupsList(end)], [0 0], ...
     ...
     'LineStyle', '--', ...
     'LineWidth', 1.5);
fill([numGroupsList, fliplr(numGroupsList)], ...
     [mean_R2_diff + sem_R2_diff; ...
      flipud(mean_R2_diff - sem_R2_diff)]', ...
     'r', ...
     'edgecolor', 'none', ...
     'facealpha', 0.2);
plot(numGroupsList, mean_R2_diff, 'r-', 'linewidth', 1.5);
xlabel('No. groups');
...
fill([numGroupsList, fliplr(numGroupsList)], ...
     ...
     'edgecolor', 'none', ...
     'facealpha', 0.2);
h1 = plot(numGroupsList, mean_RMSE_diff, 'r-', 'linewidth', 1.5);
xlabel('No. groups');
