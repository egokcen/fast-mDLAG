% fit_mdlag_bias_samplingrate_freq_taper.m
%
% Description: Fit mDLAG models via frequency domain approximation to 
%              data with increasing sampling rates. Apply a taper to the
...
parfor runIdx = 1:numRuns
    ...
    for i = 1:numPartitions
        ...
        T = length(1:sampleratio:Ttotal);  % Number of time points per trial
        seqSub = [];
        for n = train
...
for runIdx = 1:numRuns
    ...
    for i = 1:numPartitions
        ...
        currSaveFile = sprintf('%s/period%03d_freq_hamming.mat', currSaveDir, binWidth);
