% fit_mdlag_scaling_neurons_freq_taper.m
%
% Description: Fit mDLAG models via frequency domain approximation to 
%              data with increasing neuron number. Apply a taper to the
...
for runIdx = 1:numRuns
    ...
    for i = 1:numPartitions
        ...
        currSaveFile = sprintf('%s/yDim%03d_freq_taper.mat', currSaveDir, sum(yDims));
