% fit_mdlag_basic_demo_time.m
%
% Description: This script fits mDLAG models via the time domain (i.e.,
%              the standard approach) to basic demo data.
%
% Author: 
...
currSaveFile = sprintf('%s/mdlag_results_basic_demo_time.mat', currSaveDir);
