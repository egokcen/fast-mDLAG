% set_consts_mdlag_circulant.m
%
% Description: This script defines constants for circulant data 
%              simulations, specific to mDLAG experiments.
%
% Author: 
...
maxIters = 2e4;       % Maximum fitting iterations
